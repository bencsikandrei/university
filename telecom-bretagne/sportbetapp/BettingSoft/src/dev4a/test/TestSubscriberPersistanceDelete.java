...
public class TestSubscriberPersistanceDelete {
	...
	public void testSubscriberPersistance() throws BadParametersException, AuthenticationException , SubscriberException , ExistingSubscriberException{
		...
		/* get the sub and unsub */
		long tokensDue = bs.unsubscribe(userName, mgrPass);
		/* get him back Should be NULL */
		assertNull(bs.getSubscriberByUserName(userName));
		/* check the amount due */
		assertEquals(nbTokens, tokensDue);
